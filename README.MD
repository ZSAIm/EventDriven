...
```python
from eventdriven import Controller, session
from eventdriven.plugins.subprocess import Subprocess
...
if __name__ == '__main__':
    ...
    con = Controller()
    con.add_plugin(Subprocess(mapping={'1': subprocess_print_dispatch}, maxsize=10))
